...
public class AnimalMonitor 
{
    ...
    /**
     * Print the details of all the sightings of the given animal in a given period.
     * @param animal The type of animal.
     */
    public void printSightingsOfAnimalInPeriod(int period, String animal)
    {
        sightings.stream()
            .filter(s -> period == (s.getPeriod()))
            .filter(s -> animal.equals(s.getAnimal()))
    ...
    public void printSightingsBy(int spotter)
    {
        ...
        sightings.stream()
            ...
            .forEach(System.out::println(.getDetails());
